...
* [Submit a post for your issue](https://github.com/MartinHinz/sensitivity.sumcal.article.2020/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/MartinHinz/sensitivity.sumcal.article.2020/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:your-username/sensitivity.sumcal.article.2020.git`
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/MartinHinz/sensitivity.sumcal.article.2020/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/MartinHinz/sensitivity.sumcal.article.2020/compare/).
...
* Engage in discussion on [your issue](https://github.com/MartinHinz/sensitivity.sumcal.article.2020/issues/).
